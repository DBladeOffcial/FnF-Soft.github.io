function onCreate()
	makeLuaSprite('bg', 'promise/bg', -312.05, -48)
	setScrollFactor('bg', 0.2, 0.2)
	addLuaSprite('bg')

	makeLuaSprite('cloud', 'promise/cloud', -253.2, 6)
	setScrollFactor('cloud', 0.1, 0.1)
	addLuaSprite('cloud')

	makeAnimatedLuaSprite('train', 'promise/train', -2200, 234)
